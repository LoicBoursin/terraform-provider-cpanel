...
description: |-
  Manage cPanel account API tokens, cron jobs, DNS records, domains, email accounts, forwarders, autoresponders, FTP accounts, website IP blocks, and MySQL, MariaDB, and PostgreSQL users and databases.
---
