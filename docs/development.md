...
accounts, Apache handlers, directory indexes, forwarders and autoresponders,
FTP accounts, MySQL or MariaDB users and databases, PostgreSQL users and
...
FTP accounts, MySQL or MariaDB, and PostgreSQL.
