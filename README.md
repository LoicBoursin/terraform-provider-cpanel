...
email and FTP accounts, and MySQL, MariaDB, and PostgreSQL users and databases
...
- cPanel `134.x` over HTTPS with Cron, DNS Zone Editor, domains, email and FTP
  accounts, MySQL or MariaDB, and PostgreSQL enabled
