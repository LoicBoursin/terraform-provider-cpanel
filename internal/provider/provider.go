...
func (p *cpanelProvider) DataSources(_ context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		...
		NewAccountEmailFilterDataSource,
		...
		NewCalendarDelegatesDataSource,
		NewCronJobDataSource,
		NewDAVUsersDataSource,
		...
		NewMySQLRemoteHostsDataSource,
		NewMySQLRestrictionsDataSource,
		NewMySQLUserDataSource,
		NewMySQLUsersDataSource,
